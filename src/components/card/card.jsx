      ...
      <div className="rounded-[14px] shadow-lg transition-all duration-900 p-4 hover:bg-skin-transparent hover:transition-all hover:duration-900">
        ...
        <div className="pt-4">
          ...
          <div className="flex gap-[10px] items-center bg-skin-secondary p-[12px] rounded-[8px]">
            ...
            />
            <div>
              <p className=" text-custom-p relative pl-[25px] text-skin-textBase before:block before:content-[''] before:w-[7.16px] before:h-[7.16px] before:bg-skin-green before:rounded-full before:absolute before:left-[5px] before:top-[44%]">
                {author}
              </p>
              <div className="flex gap-2 items-center">
                <CiCalendarDate />{" "}
                <p className="relative text-custom-p text-skin-grey ">{date}</p>
              </div>
            </div>
          </div>
        </div>
